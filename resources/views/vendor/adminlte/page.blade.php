                ...
                <div class="sidebar">
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column {{config('adminlte.classes_sidebar_nav', '')}}" data-widget="treeview" role="menu" @if(config('adminlte.sidebar_nav_animation_speed') != 300) data-animation-speed="{{config('adminlte.sidebar_nav_animation_speed')}}" @endif @if(!config('adminlte.sidebar_nav_accordion')) data-accordion="false" @endif>
                            ...
                            <li class="nav-header">Gestion du serveur</li>

                            <li class="nav-item ">
                                <a class="nav-link {{ \Request::is('dashboard/forms') || \Request::is('dashboard/forms/*') ? 'active' : '' }}" href="{{ route('dashboard-formbuilder::forms.forms.index') }}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ \Request::is('dashboard/player') || \Request::is('dashboard/player/*') ? 'active' : '' }}" href="{{ route('dashboard-player.index') }}">
                                    <i class="fas fa-fw fa-user "></i>
                                    <p>Joueurs</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ \Request::is('dashboard/connected') || \Request::is('dashboard/connected/*') ? 'active' : '' }}" href="{{ route('dashboard-connected_player') }}">
                                    <i class="fas fa-fw fa-user "></i>
                                    <p>Joueurs Connecter</p>
                                </a>
                            </li>

                                <li class="nav-item">
                                    <a class="nav-link {{ \Request::is('dashboard/license') || \Request::is('dashboard/license/*') ? 'active' : '' }}" href="{{ route('dashboard-license.index') }}">
                                        <i class="fas fa-fw fa-id-badge"></i>
                                        <p>Licenses</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ \Request::is('dashboard/vehicule') || \Request::is('dashboard/vehicule/*') ? 'active' : '' }}" href="{{ route('dashboard-vehicule.index') }}">
                                ...
                                <li class="nav-item has-treeview">
                                    <a class="nav-link nav-item {{ \Request::is('dashboard/organisation') || \Request::is('dashboard/job') ? 'active' : '' }}" href="#">
                                        <i class="fas fa-city "></i>
                                        <p>Entreprises <i class="fas fa-angle-left right"></i></p>
                                    </a>
                                    <ul class="nav nav-treeview" style="display: none;">
                                        <li class="nav-item has-treeview">
                                            <a class="nav-link nav-item {{ \Request::is('dashboard/organisation/*') ? 'active' : '' }}" href="{{ route('dashboard-organisation.index') }}">
                                                <i class="far fa-fw fa-circle "></i>
                                                <p>Illégales <i class="fas fa-angle-left right"></i></p>
                                            </a>
                                            <ul class="nav nav-treeview">
                                                @foreach(\App\Models\FiveM\Organisation::all() as $org)
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ route('dashboard-organisation.show', ['organisation' => $org]) }}">
                                                            <i class="far fa-fw fa-circle "></i>
                                                            <p>{{ $org->label }}</p>
                                                        </a>
                                                    </li>
                                        ...
                                        <li class="nav-item has-treeview">
                                            <a class="nav-link nav-item {{ \Request::is('dashboard/job/*') ? 'active' : '' }}" href="{{ route('dashboard-job.index') }}">
                                                <i class="far fa-fw fa-circle "></i>
                                                <p>Légales <i class="fas fa-angle-left right"></i></p>
                                            </a>
                                            <ul class="nav nav-treeview">
                                                @foreach(\App\Models\FiveM\Job::all() as $job)
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ route('dashboard-job.show', ['job' => $job]) }}">
                                                            <i class="far fa-fw fa-circle "></i>
                                                            <p>{{ $job->label }}</p>
                                                        </a>
                                                    </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" class="{{ \Request::is('dashboard/gallery') || \Request::is('dashboard/gallery/*') ? 'active' : '' }}" href="{{ route('dashboard-gallery.index') }}" >
                                        <i class="fas fa-folder"></i>
                                        <p>Galerie</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="http://51.38.60.15:40120/" target='_blank'>
                                        <i class="fas fa-desktop"></i>
                                        <p>Panel externe</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="https://docs.google.com/document/d/1CcVuY6dijtGCn56kgyFpNtcZCUlDkl73fK_7-RRQMiY/edit?usp=sharing" target='_blank'>
                                        <i class="fas fa-folder"></i>
                                        <p>Règlement staff</p>
                                    </a>
                                </li>
