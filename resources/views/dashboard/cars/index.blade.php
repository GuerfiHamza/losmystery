    ...
    <div class="container grid px-6 mx-auto">
        <div class="flex justify-between items-center">
            ...
            <button
                ...
                aria-label="Update" x-on:click="setModalUpdate('{{ route('dashboard-cars.store') }}')" @click="openJob">
                Ajouter un vehicule
            </button>
        </div>
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Nom du vehicules</th>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex">
                                        <button
                                            ...
                                            x-on:click="setModalDelete('{{ route('dashboard-cars.destroy', compact('car')) }}')">
                                        ...
                                        <a href="{{ route('dashboard-cars.edit', compact('car')) }}"
                                                                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
>
                                            <g id="Complete">
    ...
    <div x-show="isJobOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
        ...
        <div x-show="isJobOpen" x-transition:enter="transition ease-out duration-150"
            ...
            <header class="flex justify-between">
                <h5 class="font-medium dark:text-white">Ajouter un vehicule</h5>
                <button
                    class="inline-flex items-center justify-center w-6 h-6 text-gray-400 transition-colors duration-150 rounded dark:hover:text-gray-200 hover: hover:text-gray-700"
            ...
            <form action="" id="update-car" method="post">
                @csrf

                <div class="mt-4 mb-6">

                    <input type="text" name="name" id="name" placeholder="Nom du vehicule"
