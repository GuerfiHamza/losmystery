...
<div
    ...
    <div class="flex flex-col flex-1">
        <header class="z-10 py-4  shadow-md   bg-gray-50 dark:bg-gray-800">
          <div
          ...
          >
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
              <div
                class="relative w-full max-w-xl mr-6 focus-within:text-red-500"
              >
              <form action="{{route('dashboard-recherche')}}" method="get">
                @csrf
                @method('get')
                ...
                <input
                  ...
                  type="text"
                  name="search"
                  placeholder="Recherche de joueurs"
                  aria-label="Search"
                />
              </form>
              </div>
              ...
              <li class="relative">
                ...
                <template x-if="isProfileMenuOpen">
                  <ul
                    ...
                    @keydown.escape="closeProfileMenu"
                    class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600  border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 bg-gray-300 dark:bg-gray-800"
                    aria-label="submenu"
                  >
                  <li class="flex">
                    <a
                    ...
                    <svg fill="none" xmlns="http://www.w3.org/2000/svg" 
                     viewBox="0 0 50 50" width="50px" height="50px" class="w-4 h-4 mr-3"
                          stroke-width="2"
                          stroke="currentColor"
        ...
        <main class="h-full pb-16 overflow-y-auto dark:bg-gray-700">
          @flasher_render
            @yield('content')
        </main>
    </div>
