...
<head>
    ...
    <title>WickedLife LSPD - @yield('title')</title>
    ...
    <nav class="bg-grey-900 py-6 px-12 md:py-2 font-opensans">
        <div class="px-8 mx-auto md:flex md:items-center">
            ...
            <div class="flex justify-between items-center">
                <a href="{{route('bank-bank.index')}}" class="font-bold text-xl text-yellow-600"><img src="/img/logo.png" class="w-20" alt=""></a>
                <button
            ...
            <div class="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
                <a href="{{ route('bank-bank.index') }}" class="p-2 lg:px-4 md:mx-2 text-white rounded-2xl @if(Request::is('bank-bank.index'))  bg-yellow-600 @else hover:bg-gray-200 hover:text-gray-700 @endif transition-colors duration-300">Accueil</a>
                <a href="{{ route('bank-bank.create') }}" class="p-2 lg:px-4 md:mx-2 text-white rounded-2xl @if(Request::is('bank-bank.create'))  bg-yellow-600 @else hover:bg-gray-200 hover:text-gray-700 @endif transition-colors duration-300">Créer un dossier</a>
                <a href="{{ route('bank-lent.index') }}" class="p-2 lg:px-4 md:mx-2 text-white rounded-2xl @if(Request::is('bank-lent.index'))  bg-yellow-600 @else hover:bg-gray-200 hover:text-gray-700 @endif transition-colors duration-300">Prêt bancaire</a>
