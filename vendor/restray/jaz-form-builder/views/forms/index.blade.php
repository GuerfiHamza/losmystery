            ...
            <div class="card rounded-0">
                ...
                @if($forms->count())
                    <div class="table-responsive">
                        <table class="table pb-0 mb-0 table-bordered d-table table-striped">
                            <thead>
                                <tr>
                                    <th class="five">#</th>
                                    <th>Name</th>
                                ...
                                @foreach($forms as $form)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('formbuilder::forms.show', $form) }}" data-turbolinks="false" class="btn btn-primary btn-sm" title="Preview form '{{ $form->name }}'">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{ route('formbuilder::forms.edit', $form) }}" data-turbolinks="false" class="btn btn-primary btn-sm" title="Edit form" >
                    ...
                    @if($forms->hasPages())
                        <div class="pb-0 mb-0 card-footer">
                            <div>{{ $forms->links() }}</div>
                        </div>
                    @endif
                @else
