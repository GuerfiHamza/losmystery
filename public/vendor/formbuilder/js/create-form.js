jQuery(function() {
    ...
    fbClearBtn.click(function(e) {
        ...
        sConfirm("Etes vous sur de vouloir supprimer tous les champs du formulaires?", function() {
    ...
    fbSaveBtn.click(function(e) {
        ...
        if (! formBuilder.actions.getData().length) {
            swal({
                title: "Error",
                text: "Le formulaire ne peut pas etre vide",
                icon: 'error',
            })
            return
        }
        ...
        sConfirm("Sauvegarder le formulaire?", function() {
            ...
            var postData = {
                ...
                enabled: $('input[name=enabled]:checked', '#createFormForm').val(),
